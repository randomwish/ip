...
description: Generate a self-contained, GitHub-style split-view HTML page that visually presents changes in this project’s Git repository. Use when asked to show, review, share, or inspect code changes visually; compare revisions, branches, commits, or the worktree; or create an HTML diff.
---
...
1. Treat this repository as the target unless the user identifies another
   repository.
...
4. Run the bundled generator from the repository root:
   ...
   The comparison points can be any Git commit-ish such as `HEAD~1`, a tag, a
...
generator based on
`https://github.com/se-edu/skill-present-changes-visually`. Keep the page
self-contained except for the optional syntax-highlighting resources loaded by
the page.
